...
class BiasControlWindow(QMainWindow):
    ...
    def _build_history_panel(self) -> QWidget:
        ...
        self.chart.setBackgroundBrush(QColor("#0c121b"))
        self.chart.setPlotAreaBackgroundBrush(QColor("#0c121b"))
        self.chart.setPlotAreaBackgroundVisible(True)
        self.chart.legend().setAlignment(Qt.AlignmentFlag.AlignTop)
        self.chart.legend().setLabelColor(QColor("#d5dfeb"))
        ...
        axis_pen = QPen(QColor("#aebed0"), 1)
        grid_pen = QPen(QColor("#334355"), 1)
        minor_grid_pen = QPen(QColor("#202d3a"), 1)
        for axis in (self.time_axis, self.bias_axis):
            axis.setLinePen(axis_pen)
            axis.setLabelsColor(QColor("#b9c7d8"))
            axis.setTitleBrush(QColor("#b9c7d8"))
    ...
    def _apply_stylesheet(self) -> None:
        self.setStyleSheet(
            ...
            QLabel#appTitle { font-size: 17pt; font-weight: 650; color: white; }
            QLabel#appSubtitle, QLabel#mutedText { color: #94a5ba; }
            QLabel#sectionTitle { font-size: 12pt; font-weight: 650; color: white; }
            QLabel#channelName { font-size: 11pt; font-weight: 650; color: white; }
            QLabel#fieldCaption {
                color: #88a0ba;
                font-size: 8pt;
                font-weight: 650;
            }
            QLabel#heroValue { color: #76b7ff; font-size: 14pt; font-weight: 650; }
            QLabel#readoutValue { color: #dbe7f4; font-weight: 650; }
            QLabel#biasReadout { color: #82e3aa; font-size: 13pt; font-weight: 700; }
            QLabel#infoBanner {
                background: #0d3040;
                color: #b9e8f7;
            ...
            QLabel#statusOff { background: #29323d; color: #aeb9c5; }
            QLabel#statusWarn { background: #4a3712; color: #ffd079; }
            QLabel#statusOn { background: #123e2d; color: #82e3aa; }
            QLabel#stateLabel {
                border-radius: 5px;
                padding: 2px 5px;
                font-size: 8pt;
            }
            QLabel#stateLabel[state="idle"] { background: #27313d; color: #aab6c4; }
            QLabel#stateLabel[state="pending"] { background: #4a3712; color: #ffd079; }
            QLabel#stateLabel[state="applied"] { background: #123e2d; color: #82e3aa; }
            QLabel#stateLabel[state="error"] { background: #54252b; color: #ff9aa2; }
            QPushButton {
                background: #273548;
            ...
            QPushButton:hover { background: #31435a; }
            QPushButton:pressed { background: #1f2c3b; }
            QPushButton:disabled { color: #657488; background: #1b2531; border-color: #2a3746; }
            QPushButton#primaryButton { background: #2878d4; border-color: #4292ee; color: white; }
            QPushButton#primaryButton:hover { background: #3388e6; }
            QPushButton#dangerButton { background: #742f38; border-color: #a64a56; color: white; }
            QPushButton#dangerButton:hover { background: #8b3944; }
            ...
            QSplitter::handle { background: #0d131b; width: 7px; }
            QStatusBar { background: #0a1017; color: #90a1b5; }
            QToolTip { background: #253345; color: white; border: 1px solid #50657d; }
            """
        )
